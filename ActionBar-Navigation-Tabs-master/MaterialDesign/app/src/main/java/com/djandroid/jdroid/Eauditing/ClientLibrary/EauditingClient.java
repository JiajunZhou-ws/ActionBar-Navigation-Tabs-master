package com.djandroid.jdroid.Eauditing.ClientLibrary;

import com.djandroid.jdroid.Eauditing.ClientLibrary.Common.ClientConfiguration;
import com.djandroid.jdroid.Eauditing.ClientLibrary.HttpModel.AndroidTaskService.PictureSaveRequest;
import com.djandroid.jdroid.Eauditing.ClientLibrary.HttpModel.AndroidTaskService.TaskSaveRequest;
...
import com.djandroid.jdroid.Eauditing.ClientLibrary.Common.EAuditingHttpResponse;
import com.djandroid.jdroid.Eauditing.ClientLibrary.Common.HttpWrapper;
import com.djandroid.jdroid.Eauditing.ClientLibrary.HttpModel.AndroidTaskService.GetTaskListRequest;
import com.djandroid.jdroid.Eauditing.ClientLibrary.HttpModel.AndroidTaskService.GetTaskListResponse;
...
import com.djandroid.jdroid.Eauditing.ClientLibrary.HttpModel.UserService.*;
...
public class EauditingClient {
    ...
    public static UserLoginResponse UserLogin(String userName, String password)
    {
        ...
        try {
            ...
            request.setVersion(ClientConfiguration.Version);
    ...
    public static String TaskSave(String taskid, String categoryId, List<TaskItem> itemList)
    {
        ...
        request.itemList = itemList;    //新增加的item直接加在里面 uuid
